# Example from the pyoculus repository:
...
if __name__ == "__main__":
    ...
    # plt.savefig("island.png", dpi=300, bbox_inches="tight")  
    # plt.show() # Doesn't wprk in cluster, need to save figure to see it
    ...
    fig, ax = pplot.plot(marker=".", s=0.5, xlim=[2., 4.], ylim=[-1.2, 1.2])
    # plt.show() # Doesn't work in cluster, need to save figure to see it
